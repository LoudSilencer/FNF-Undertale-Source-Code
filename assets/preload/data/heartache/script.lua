...
local xx = 0/2; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
local yy = 0/2; -- Code to change the position of the camera up or down for the enemy Less = Down (They can be negative numbers), More = Up
local xx2 = 620; -- Same code as above, but for boyfriend left, right
local yy2 = 450; -- Same code as above, but for boyfriend up, down
local xx3 = 0/2; -- Same code as above, but for girlfriend left, right
local yy3 = 0/2; -- Same code as above, but for girlfriend, up, down
local ofs = 10; -- Code to adjust the intensity with which the camera moves, the more numbers, the more intense, and the fewer numbers, less intense
