...
class RPGSaveInGame extends MusicBeatState
{
		...
		if (controls.ACCEPT) {
			...
			switch(options[curSelected]) {
				case 'Save 1':
					...
					RPGSaveInGame.saveFile = 1;

				case 'Save 2':
					openSubState(new SaveSubState());
					RPGSaveInGame.saveFile = 2;

				case 'Save 3':
					openSubState(new SaveSubState());
					RPGSaveInGame.saveFile = 3;
			}
		}
	}
...
class SaveSubState extends MusicBeatSubstate
{
	...
	override function update(elapsed:Float)
	{
		...
		if (controls.ACCEPT && nextAccept <= 0) {
			...
			switch(options[curSelected]) {
				case 'SAVE':
					RPGState.saveIndex = RPGSaveInGame.saveFile;
					switch (RPGSaveInGame.saveFile)
					{
						case 1:
							RPGLoadingSaveState.saveData1();
						case 2:
							RPGLoadingSaveState.saveData2();
						case 3:
							RPGLoadingSaveState.saveData3();
					}
					changeSelection();
			}
		}
